...
# endif
	...
	{
		.procname	= "latency_breakdown_validation",
		.data		= &sysctl_net_latency_breakdown_validation,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_douintvec,
	},
	{
		.procname	= "latency_dumb_schedule_enable",
		.data		= &sysctl_net_latency_dumb_schedule_enable,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_douintvec,
	},
	{
		.procname	= "latency_dumb_schedule_weight",
		.data		= &sysctl_net_latency_dumb_schedule_weight,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_douintvec,
	},
	{
		.procname	= "latency_dumb_schedule_disable_clamp",
		.data		= &sysctl_net_latency_dumb_schedule_disable_clamp,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_douintvec,
	},
	{
		.procname	= "latency_perstage_rdpmc_on",
		.data		= &sysctl_net_latency_perstage_rdpmc_on,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_douintvec,
	},
