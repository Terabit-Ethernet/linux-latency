...
# endif
	...
	{
		.procname	= "latency_dumb_schedule_complete",
		.data		= &sysctl_net_latency_dumb_schedule_complete,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_douintvec,
	},
	{
		.procname	= "latency_dumb_schedule_tcp_send",
		.data		= &sysctl_net_latency_dumb_schedule_tcp_send,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_douintvec,
	},
	{
		.procname	= "latency_dumb_schedule_rx_sleep",
		.data		= &sysctl_net_latency_dumb_schedule_rx_sleep,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_douintvec,
	},
